...
export default class FarmaciaMedioDePago extends BaseModel {
  ...
  public farmacia_mediodepago_id_mediodepago: HasOne<typeof MedioDePago>;

  @hasOne(() => Usuario, {
    foreignKey: "id",
  })
  public farmacia_mediodepago_id_usuario_creacion: HasOne<typeof Usuario>;

  @hasOne(() => Usuario, {
    foreignKey: "id",
  })
  public farmacia_mediodepago_id_usuario_modificacion: HasOne<typeof Usuario>;
}
