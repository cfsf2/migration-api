...
export default class EventoParticipante extends Base {
  ...
  @column()
  public id_evento_participante_tipo: number;
  ...
  @beforeSave()
  public static async verpagado(_invitado: EventoParticipante) {
    // if (_invitado.$dirty.pagado) {
    //   if (_invitado.$original.pagado === "s") {
    //     _invitado.pagado = 's'
    //   }
    // }
  }
