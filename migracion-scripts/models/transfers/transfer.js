...
var schema = new mongoose.Schema(
  {
    ...
    productos_solicitados: [
      {
        _id: { type: mongoose.Schema.Types.ObjectId, ref: "productostranfers" },
...
schema.plugin(AutoIncrement, { inc_field: "codigo_transfer" });
